    ...
    response_data = @inter_raters.map do |inter_rater|
      {
        ...
        first_conversation_fine_tune_data: ModelFineTuneRequest.where(new_ai_model_id: inter_rater.first_conversation.ai_model.id)&.last&.fine_tune_data,
        ...
        second_conversation_fine_tune_data: ModelFineTuneRequest.where(new_ai_model_id: inter_rater.second_conversation.ai_model.id)&.last&.fine_tune_data,
